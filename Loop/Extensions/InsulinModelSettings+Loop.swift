...
extension ExponentialInsulinModelPreset {
    var title: String {
        ...
        case .novoRapid50h:
             return NSLocalizedString("NovoRapid (5h)", comment: "Title of insulin model preset")
    ...
    var subtitle: String? {
        ...
        case .novoRapid40h:
         ...
         case .novoRapid50h:
             return NSLocalizedString("A model based on observed absorption of NovoRapid over 5h", comment: "Subtitle for NovoRapid(5h)")
        case .humalogNovologChild:
